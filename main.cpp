...
int main()
{
    ...
    hitable *list[4];
    list[0] = new sphere(vec3(0.0f, -100.5f, -1.0f), 100.0f, new metal(vec3(0.9f,0.3f,0.3f),0.2f));
    list[1] = new sphere(vec3(0.0f, 0.0f, -1.0f), 0.5f, new metal(vec3(1.0f,1.0f,1.0f),0.0f));
    list[2] = new sphere(vec3(1.0f,0.0f,-1.0f),0.5f, new lambertian(vec3(0.7f,0.7f,0.8f)));
    list[3] = new sphere(vec3(-1.0f,0.0f,-1.0f),0.5f, new lambertian(vec3(0.1f,0.4f,0.9f)));
